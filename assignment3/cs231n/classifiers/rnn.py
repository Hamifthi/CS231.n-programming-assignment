...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        # step 5
        loss, grads['scores'] = temporal_softmax_loss(scores, captions_out, mask)
        ...
        grads['features'], grads['W_proj'], grads['b_proj'] = affine_backward(grads['initial_hidden_state'], initial_hidden_cache)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
